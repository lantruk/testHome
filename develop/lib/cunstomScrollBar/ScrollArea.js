...
export default class ScrollArea extends React.Component{
    constructor(props){
        ...
        this.state = {
            topPosition: this.props.topPosition || 0,
            leftPosition: 0,
            realHeight: 0,
            containerHeight: 0,
            realWidth: 0,
    ...
    componentWillReceiveProps(nextProps){
        ...
        if(nextProps.topPosition) {
            const position = this.normalizeTopPosition(nextProps.topPosition, this.computeSizes());
        ...
        if(nextProps.active && !this.props.active){
            this.showScrollTimeout && clearTimeout(this.showScrollTimeout)
            this.showScrollTimeout = setTimeout(this.setSizesToState.bind(this), 300)
        }
    ...
    computeSizes(){
        ...
        return {
            ...
            containerHeight: this.props.active ? containerHeight : 0,
            realWidth: realWidth,
    ...
    setSizesToState(){
        ...
        if(sizes.realHeight !== this.state.realHeight || sizes.realWidth !== this.state.realWidth || sizes.containerHeight !== this.state.containerHeight){
