...
const ThemedMenuItem = menuItemFactory(themedRippleFactory({}));
const ThemedMenu = menuFactory(ThemedMenuItem);
const ThemedIconMenu = iconMenuFactory(IconButton, ThemedMenu);
export { ThemedMenuItem as MenuItem };
export { ThemedMenu as Menu };
export { ThemedIconMenu as IconMenu };